      ...
      switch (annotation.annotationType) {
        ...
        case AnnotationEditorType.HIGHLIGHT:
          if (annotation.quadPoints) {
            promises.push(
              HighlightAnnotation.createNewAnnotation(xref, annotation, changes, // added by Jan
...
function createHTMLStringFromObject(obj) {
  ...
  // Start the element with the tagName
  ...
  if (obj.attributes) {
    for (let attr in obj.attributes) {
      //ignore the first id, because this was generated by the tool and might be the same again
      if (attr !== "id") {
      ...
      //transform the ids I want to actual IDs
